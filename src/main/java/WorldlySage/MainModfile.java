...
public class MainModfile implements
    ...
    public MainModfile() {
        ...
        BaseMod.addColor(TheWorldlySage.Enums.SAGELY_MALIBU_COLOR, SAGELY_MALIBU_COLOR, SAGELY_MALIBU_COLOR, SAGELY_MALIBU_COLOR,
                SAGELY_MALIBU_COLOR, SAGELY_MALIBU_COLOR, SAGELY_MALIBU_COLOR, SAGELY_MALIBU_COLOR,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheWorldlySage(TheWorldlySage.characterStrings.NAMES[1], TheWorldlySage.Enums.THE_WORLDLY_SAGE),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheWorldlySage.Enums.THE_WORLDLY_SAGE);
