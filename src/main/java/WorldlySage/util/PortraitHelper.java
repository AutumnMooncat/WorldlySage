...
public class PortraitHelper {
    ...
    private static final Texture attackMask = TexLoader.getTexture("WorldlySageResources/images/masks/AttackMask.png");
    private static final Texture skillMask = TexLoader.getTexture("WorldlySageResources/images/masks/SkillMask.png");
    private static final Texture powerMask = TexLoader.getTexture("WorldlySageResources/images/masks/PowerMask.png");
