...
public class ColorTabPatch {
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(makeID(TheWorldlySage.class.getSimpleName()));
    ...
    public static class ChangeName {
        ...
        public static void plz(AbstractPlayer.PlayerClass playerClass, @ByRef String[] tabName) {
            if (playerClass == TheWorldlySage.Enums.THE_WORLDLY_SAGE) {
