...
import WorldlySage.util.TextureSniper;
...
public class TransportCannonAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        for (AbstractCard c : Wiz.adp().hand.group) {
            addToTop(new VFXAction(VFXContainer.throwEffect(TextureSniper.snipeCard(c), 0.25f, target.hb, MainModfile.SAGELY_MALIBU_COLOR, true, false)));
        }
