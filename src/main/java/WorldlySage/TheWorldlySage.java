...
import WorldlySage.cards.*;
import WorldlySage.cards.interfaces.SkillAnimationAttack;
import WorldlySage.relics.WaterOrb;
...
import static WorldlySage.MainModfile.*;

public class TheWorldlySage extends CustomPlayer {
    ...
    static final String ID = makeID(TheWorldlySage.class.getSimpleName());
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheWorldlySage(String name, PlayerClass setClass) {
    ...
    public AbstractCard.CardColor getCardColor() {
        return Enums.SAGELY_MALIBU_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return MainModfile.SAGELY_MALIBU_COLOR.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheWorldlySage(name, chosenClass);
    }
    ...
    public Texture getCutsceneBg() {
        return ImageMaster.loadImage("WorldlySageResources/images/panels/bkg.png");
    }

    @Override
    public List<CutscenePanel> getCutscenePanels() {
        List<CutscenePanel> panels = new ArrayList<>();
        panels.add(new CutscenePanel("WorldlySageResources/images/panels/HeartPanel.png", "UNLOCK_PING"));
        return panels;
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_WORLDLY_SAGE;
        @SpireEnum(name = "SAGELY_MALIBU_COLOR")
        public static AbstractCard.CardColor SAGELY_MALIBU_COLOR;
        @SpireEnum(name = "SAGELY_MALIBU_COLOR")
