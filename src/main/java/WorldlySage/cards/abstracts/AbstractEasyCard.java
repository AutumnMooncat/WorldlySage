package WorldlySage.cards.abstracts;

import WorldlySage.MainModfile;
import WorldlySage.TheWorldlySage;
import WorldlySage.util.CardArtRoller;
...
import static WorldlySage.MainModfile.makeImagePath;
import static WorldlySage.MainModfile.modID;
import static WorldlySage.util.Wiz.atb;
import static WorldlySage.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheWorldlySage.Enums.SAGELY_MALIBU_COLOR);
    }
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        FlavorText.AbstractCardFlavorFields.boxColor.set(this, mix(BLACK.cpy(), MainModfile.SAGELY_MALIBU_COLOR.cpy()));
