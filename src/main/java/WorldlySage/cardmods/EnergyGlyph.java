...
public class EnergyGlyph extends AbstractCardModifier {
    public static String ID = makeID(EnergyGlyph.class.getSimpleName());
    public static Texture modIcon = TexLoader.getTexture(MainModfile.makeImagePath("icons/ball-glow.png"));
    ...
    public boolean shouldApply(AbstractCard card) {
        if (CardModifierManager.hasModifier(card, ID)) {
            EnergyGlyph glyph = (EnergyGlyph) CardModifierManager.getModifiers(card, ID).get(0);
